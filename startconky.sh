...
conky -c ~/.conky/Conky-Rings-Improved/rings & # the main conky with rings
...
conky -c ~/.conky/Conky-Rings-Improved/cpu &
sleep 1
conky -c ~/.conky/Conky-Rings-Improved/mem &
conky -c ~/.conky/Conky-Rings-Improved/notes &
conky -c ~/.conky/Conky-Rings-Improved/rss &
#conky -c ~/.conky/Conky-Rings-Improved/spotify &
